...
class Nozzle {
  ...
  private:
    ...
    /**
     * @brief Stroke clean pattern with no extrusion
     * @details Apply a circular cleaning pattern
     *
     * @param start xyz_pos_t defining the middle of circle
     * @param strokes number of strokes to execute
     * @param radius radius of circle
     */
    static void stroke_with_extrusion(const xyz_pos_t &start, const xyz_pos_t &end, const uint8_t &strokes) _Os;
