...
void kill(PGM_P const lcd_error/*=nullptr*/, PGM_P const lcd_component/*=nullptr*/, const bool steppers_off/*=false*/) {
  ...
  analogWrite(LINC_3LED_RED, 255);  //LINCSOLUTION CUSTOM CODE - EMERGENCY STATUS 
  thermalManager.setTargetBed(0);   //LINCSOLUTION CUSTOM CODE - EMERGENCY STATUS 
  thermalManager.setTargetHotend(0, 0); //LINCSOLUTION CUSTOM CODE - EMERGENCY STATUS 
  thermalManager.setTargetHotend(0, 1); //LINCSOLUTION CUSTOM CODE - EMERGENCY STATUS 
