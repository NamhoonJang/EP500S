...
void Endstops::init() {
  SET_INPUT_PULLUP(LINC_E2_ENDSTOP_PIN); //CUSTOMED BY LINCSOLUTION J.N.H.
  SET_INPUT_PULLUP(LINC_VACCUM_PASS_FAIL_PIN); //LINCSOLUTION CUSTOM CODES
  //SET_INPUT_PULLUP(LINC_MOTOR_ALARM_READ_PIN); //LINCSOLUTION CUSTOM CODES
  #if HAS_X_MIN
