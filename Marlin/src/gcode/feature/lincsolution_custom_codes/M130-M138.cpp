...
float probePosX = Z_SAFE_HOMING_X_POINT; //24;
float probePosY = Z_SAFE_HOMING_Y_POINT; //254;
  ...
  void GcodeSuite::M130()
    ...
    */
    ...
    {   
        ...
        const xy_pos_t pos = {probePosX, probePosY}; /* {24, 254}; */   //set the probing XY positions.
