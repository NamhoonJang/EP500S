 ...
 */
#if ANY(LINCSOLUTION_CUSTOM_PROBE, HAS_Z_SERVO_PROBE, FIX_MOUNTED_PROBE, NOZZLE_AS_PROBE, TOUCH_MI_PROBE, Z_PROBE_ALLEN_KEY, Z_PROBE_SLED, SOLENOID_PROBE, SENSORLESS_PROBING, RACK_AND_PINION_PROBE)
...
#endif
//LINCSOLUTION CUSTOM ENDSTOPS
#if E2_HOME_DIR > 0
  #define E2_HOME_TO_MAX 1
#elif E2_HOME_DIR < 0
  #define E2_HOME_TO_MIN 1
#endif
